Instance: e20a815b-81c6-4f0e-982c-d29e56f74066
...
* masterIdentifier.value = "urn:uuid:e20a1ea3-ac0c-44fa-93c0-eae8d0e2abd9" //Samme som identifier.value
* identifier.value = "urn:uuid:e20a1ea3-ac0c-44fa-93c0-eae8d0e2abd9" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-05-20T10:20:30+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-20T10:00:00+02:00"
