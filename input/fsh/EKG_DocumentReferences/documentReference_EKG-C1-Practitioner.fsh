Instance: e08a5fae-e7af-4fc2-960b-c6989eb72979
...
* masterIdentifier.value = "urn:uuid:e08a697e-8e35-41ad-a321-850cd380fd7c" //Samme som identifier.value
* identifier.value = "urn:uuid:e08a697e-8e35-41ad-a321-850cd380fd7c" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-05-08T08:06:07+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-08T12:08:09+02:00"
