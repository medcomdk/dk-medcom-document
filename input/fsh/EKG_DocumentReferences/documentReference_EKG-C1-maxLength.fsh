Instance: e04acbce-c9f0-47e2-9635-3ecfaac2783b
...
* masterIdentifier.value = "urn:uuid:e04afceb-4d9c-47fd-9571-e86b3b2417a9" //Samme som identifier.value
* identifier.value = "urn:uuid:e04afceb-4d9c-47fd-9571-e86b3b2417a9" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-03-25T11:06:43+01:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-03-25T11:05:00+01:00"
* context.period.end  = "2026-03-25T11:05:00+01:00"
