Instance: e13a3eaa-088c-4d36-a868-f568a70317c5
...
* contained[+] = 8655b003-7021-4378-9d2e-450c148d3401
...
* masterIdentifier.value = "urn:uuid:e13aa394-4690-4330-9746-080204991c6f" //Samme som identifier.value
* identifier.value = "urn:uuid:e13aa394-4690-4330-9746-080204991c6f" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-05-13T13:06:43+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-13T13:00:00+02:00"
...
* context.sourcePatientInfo = Reference(8655b003-7021-4378-9d2e-450c148d3401)