Instance: 21a45fbe-49cd-4ce2-af16-215ccb24b28a
...
* masterIdentifier.value = "urn:uuid:c8568414-8220-4dd4-a989-9a21cd7b3268" //Samme som identifier.value
* identifier.value = "urn:uuid:c8568414-8220-4dd4-a989-9a21cd7b3268" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
