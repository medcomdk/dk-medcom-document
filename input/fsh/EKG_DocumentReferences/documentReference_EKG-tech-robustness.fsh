Instance: e21a5fbe-49cd-4ce2-af16-215ccb24b28a
...
* masterIdentifier.value = "urn:uuid:e21a8414-8220-4dd4-a989-9a21cd7b3268" //Samme som identifier.value
* identifier.value = "urn:uuid:e21a8414-8220-4dd4-a989-9a21cd7b3268" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
* type = http://loinc.org#11524-6 "EKG study"
* category = urn:oid:1.2.208.184.100.9#001 "Klinisk rapport"
* subject = Reference(dk.patient-12345)
...
* content.attachment.creation = "2026-05-21T21:21:21+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-21T13:13:13+02:00"
* context.period.end  = "2026-05-21T13:14:15+02:00"
...
* context.sourcePatientInfo = Reference(dk.patient-12345)