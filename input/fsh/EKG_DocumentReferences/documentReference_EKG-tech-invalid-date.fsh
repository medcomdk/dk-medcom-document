Instance: e12aeace-e609-40a6-a078-607480bb0aa1
...
* contained[+] = a2c366dd-90db-441a-bbfd-d0bb61041352
...
* masterIdentifier.value = "urn:uuid:e12a2e6a-e58a-479d-b67e-6d703f21b710" //Samme som identifier.value
* identifier.value = "urn:uuid:e12a2e6a-e58a-479d-b67e-6d703f21b710" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
* type = http://loinc.org#11524-6 "EKG study"
* category = urn:oid:1.2.208.184.100.9#001 "Klinisk rapport"
* subject = Reference(a2c366dd-90db-441a-bbfd-d0bb61041352)
...
* content.attachment.creation = "2026-05-12T12:06:43+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-12T11:00:00+02:00"
...
* context.sourcePatientInfo = Reference(a2c366dd-90db-441a-bbfd-d0bb61041352)