Instance: e18a9c72-6c84-4c59-a092-245ca89564fd
...
* contained[+] = ff9789de-7711-4ead-8dea-73d39bc71a8b
...
* masterIdentifier.value = "urn:uuid:e18aeae5-2b9e-4fa3-bc33-33f11ab40262" //Samme som identifier.value
* identifier.value = "urn:uuid:e18aeae5-2b9e-4fa3-bc33-33f11ab40262" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
* type = http://loinc.org#11524-6 "EKG study"
* category = urn:oid:1.2.208.184.100.9#001 "Klinisk rapport"
* subject = Reference(ff9789de-7711-4ead-8dea-73d39bc71a8b)
...
* content.attachment.creation = "2026-05-18T18:00:00+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-18T08:00:00+02:00"
* context.period.end  = "2026-05-18T08:05:00+02:00"
...
* context.sourcePatientInfo = Reference(ff9789de-7711-4ead-8dea-73d39bc71a8b)