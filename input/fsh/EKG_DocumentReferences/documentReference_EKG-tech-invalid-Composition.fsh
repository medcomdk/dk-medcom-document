Instance: e11aa147-4dee-4473-8235-ddbe0bb17868
...
* contained[+] = ccc3f30d-c5e2-4329-b2ec-6b6f233244b2
...
* masterIdentifier.value = "urn:uuid:e11a5537-bfcf-4e39-a839-b58f7c0e1015" //Samme som identifier.value
* identifier.value = "urn:uuid:e11a5537-bfcf-4e39-a839-b58f7c0e1015" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-05-11T12:16:18+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-11T12:13:14+02:00"
* context.period.end  = "2026-05-11T12:14:04+02:00"
...
* context.sourcePatientInfo = Reference(ccc3f30d-c5e2-4329-b2ec-6b6f233244b2)