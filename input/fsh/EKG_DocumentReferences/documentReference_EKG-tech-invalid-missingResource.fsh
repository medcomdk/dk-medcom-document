Instance: e15a6cf4-9719-42b3-85f0-4d61afd4027f
...
* contained[+] = 7e1b4d90-6f46-41fb-95d1-ededb3c807d2
...
* masterIdentifier.value = "urn:uuid:e15a75a5-b3ce-4e13-b091-5bbd07924bd9" //Samme som identifier.value
* identifier.value = "urn:uuid:e15a75a5-b3ce-4e13-b091-5bbd07924bd9" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
* type = http://loinc.org#11524-6 "EKG study"
* category = urn:oid:1.2.208.184.100.9#001 "Klinisk rapport"
* subject = Reference(7e1b4d90-6f46-41fb-95d1-ededb3c807d2)
...
* content.attachment.creation = "2026-05-15T15:15:18+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-15T15:13:14+02:00"
* context.period.end  = "2026-05-15T15:15:16+02:00"
...
* context.sourcePatientInfo = Reference(7e1b4d90-6f46-41fb-95d1-ededb3c807d2)