Instance: bbf30821-6182-4e6b-b07a-ac940d424e23
...
* masterIdentifier.value = "urn:uuid:5012c845-fafe-4faf-92fc-efb6e0fa565a" //Samme som identifier.value
* identifier.value = "urn:uuid:5012c845-fafe-4faf-92fc-efb6e0fa565a" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
