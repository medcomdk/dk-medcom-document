Instance: e14a690e-13b0-4ccb-9975-766b4c35563f
...
* contained[+] = 9f292792-4622-46aa-b30b-6db6d120a262
...
* masterIdentifier.value = "urn:uuid:e14a7714-473c-47f5-915c-6571eb7f25b7" //Samme som identifier.value
* identifier.value = "urn:uuid:e14a27714-473c-47f5-915c-6571eb7f25b7" //Denne identifier skal udskiftes med uuid for bundle.identifier
* status = #current
...
* content.attachment.creation = "2026-05-14T14:06:43+02:00" //Indsæt Bundle.timestamp (behøves ikke i testfiler)
* content.format = urn:oid:1.2.208.184.100.10#urn:ad:dk:medcom:ekg-v2.0:full "DK EKG schema"
* context.period.start = "2026-05-14T14:00:00+02:00"
...
* context.sourcePatientInfo = Reference(9f292792-4622-46aa-b30b-6db6d120a262)